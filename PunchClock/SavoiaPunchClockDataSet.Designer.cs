...
namespace PunchClock {
    ...
    public partial class SavoiaPunchClockDataSet : global::System.Data.DataSet {
        ...
        private void InitClass() {
            ...
            this.Prefix = "";
            this.Namespace = "http://tempuri.org/SavoiaPunchClockDataSet.xsd";
        ...
        public partial class EmployeeDataTable : global::System.Data.TypedTableBase<EmployeeRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public EmployeeRow AddEmployeeRow(string Username, string FirstName, string LastName, int PinCode) {
...
namespace PunchClock.SavoiaPunchClockDataSetTableAdapters {
    ...
    public partial class EmployeeTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM `Employee` WHERE ((`EmployeeID` = ?) AND ((? = 1 AND `Username` IS NULL) OR (`Username` = ?)) AND ((? = 1 AND `FirstName` IS NULL) OR (`FirstName` = ?)) AND ((? = 1 AND `LastName` IS NULL) OR (`LastName` = ?)) AND ((? = 1 AND `PinCode` IS NULL) OR (`PinCode` = ?)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO `Employee` (`Username`, `FirstName`, `LastName`, `PinCode`) VALUES (?" +
                ", ?, ?, ?)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE `Employee` SET `Username` = ?, `FirstName` = ?, `LastName` = ?, `PinCode` = ? WHERE ((`EmployeeID` = ?) AND ((? = 1 AND `Username` IS NULL) OR (`Username` = ?)) AND ((? = 1 AND `FirstName` IS NULL) OR (`FirstName` = ?)) AND ((? = 1 AND `LastName` IS NULL) OR (`LastName` = ?)) AND ((? = 1 AND `PinCode` IS NULL) OR (`PinCode` = ?)))";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT EmployeeID, Username, FirstName, LastName, PinCode FROM Employee";
        ...
        public virtual int Delete(int Original_EmployeeID, string Original_Username, string Original_FirstName, string Original_LastName, int Original_PinCode) {
            ...
            this.Adapter.DeleteCommand.Parameters[8].Value = ((int)(Original_PinCode));
        ...
        public virtual int Insert(string Username, string FirstName, string LastName, int PinCode) {
            if ((Username == null)) {
            ...
            this.Adapter.InsertCommand.Parameters[3].Value = ((int)(PinCode));
        ...
        public virtual int Update(string Username, string FirstName, string LastName, int PinCode, int Original_EmployeeID, string Original_Username, string Original_FirstName, string Original_LastName, int Original_PinCode) {
            if ((Username == null)) {
                throw new global::System.ArgumentNullException("Username");
            }
            else {
            ...
            this.Adapter.UpdateCommand.Parameters[3].Value = ((int)(PinCode));
            ...
            this.Adapter.UpdateCommand.Parameters[12].Value = ((int)(Original_PinCode));
